package edu.amd.spbstu.roothidelist;
...
/**
 * A service that returns a timestamp of a moment when the app is initialized. This App is in Magisk Hide List.
 */

public class CreationTimeService extends IntentService {
    private static final int HIDE_APP_ID = 1;
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        passIntent.putExtra("ROOT_CHECKER_APP", HIDE_APP_ID);
